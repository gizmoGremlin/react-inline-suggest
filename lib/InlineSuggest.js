...
var InlineSuggest = /** @class */ (function (_super) {
    ...
    InlineSuggest.prototype.render = function () {
        var _a = this.props, name = _a.name, placeholder = _a.placeholder, className = _a.className, shouldRenderSuggestion = _a.shouldRenderSuggestion;
        return (react_1.default.createElement(Wrapper, { className: className },
            react_1.default.createElement(Input_1.default, { value: this.state.value, onChange: this.handleOnChange, onBlur: this.handleOnBlur, onKeyDown: this.handleOnKeyDown, onKeyUp: this.handleOnKeyUp, name: name, placeholder: placeholder }),
