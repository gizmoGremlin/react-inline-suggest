...
var InlineSuggest = /** @class */ (function (_super) {
    ...
    InlineSuggest.prototype.render = function () {
        return (react_1.default.createElement(Wrapper, { className: this.props.className },
            react_1.default.createElement(Input_1.default, { value: this.state.value, onChange: this.handleOnChange, onBlur: this.handleOnBlur, onKeyDown: this.handleOnKeyDown, onKeyUp: this.handleOnKeyUp }),
            react_1.default.createElement(Suggestion_1.default, { value: this.state.value, needle: this.getNeedle(), shouldRenderSuggestion: this.props.shouldRenderSuggestion })));
    };
