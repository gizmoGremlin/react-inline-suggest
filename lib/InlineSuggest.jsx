...
var InlineSuggest = /** @class */ (function (_super) {
    ...
    InlineSuggest.prototype.render = function () {
        ...
        <Input_1.default value={this.state.value} onChange={this.handleOnChange} onBlur={this.handleOnBlur} onKeyDown={this.handleOnKeyDown} onKeyUp={this.handleOnKeyUp}/>
        <Suggestion_1.default value={this.state.value} needle={this.getNeedle()} shouldRenderSuggestion={this.props.shouldRenderSuggestion}/>
      </Wrapper>);
    };
